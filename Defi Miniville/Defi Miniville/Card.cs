...
namespace Defi_Miniville
{
	public class Card
	{
		...
		public static void CreateDeck()
		{
			...
			AddCard(2, "Green", 1, "Bakery", 6, "Get 2 coins-", 2, 3, 2);
			...
			AddCard(6, "Red", 4, "Restaurant", 6, "Get 2 coins from the player-that rolled the die", 9, 10, 2);
			AddCard(7, "Blue", 6, "Stadium", 4, "Get 4 coins-", 6, 6, 4);
			...
			AddCard(10, "Green", 5, "Dairy", 6, "Get 3 coins foreach-farm that you have", 7, 7, 0);
